...
$defProp(Object.prototype, "is$AnchorElement", function() {
  return false;
});
...
// ********** Code for _EventJs **************
$dynamic("get$srcElement").Event = function() { return this.srcElement; };
...
$dynamic("get$port").HTMLAnchorElement = function() { return this.port; };
$dynamic("set$port").HTMLAnchorElement = function(value) { return this.port = value; };
...
$dynamic("get$port").HTMLAreaElement = function() { return this.port; };
...
$dynamic("get$port").InspectorFrontendHost = function() {
  return this.port.bind(this);
}
...
$dynamic("get$port").Location = function() { return this.port; };
$dynamic("set$port").Location = function(value) { return this.port = value; };
...
$dynamic("get$state").PopStateEvent = function() { return this.state; };
...
$dynamic("get$port").SharedWorker = function() { return this.port; };
...
$dynamic("get$length").Uint8ClampedArray = function() { return this.length; };
...
$dynamic("get$port").WorkerLocation = function() { return this.port; };
...
ElementWrappingImplementation.prototype.set$elements = function(value) {
...
AnchorElementWrappingImplementation.prototype.is$AnchorElement = function(){return true};
...
AnchorElementWrappingImplementation.prototype.get$port = function() {
  return this._ptr.get$port();
}
...
AreaElementWrappingImplementation.prototype.get$port = function() {
  return this._ptr.get$port();
}
...
EventWrappingImplementation.prototype.get$srcElement = function() {
  return LevelDom.wrapEventTarget(this._ptr.get$srcElement());
}
...
LocationWrappingImplementation.prototype.get$port = function() {
  return this._ptr.get$port();
}
...
LevelDom.wrapMessagePort = function(raw) {
  return null == raw ? null : null != raw.get$dartObjectLocalStorage() ? raw.get$dartObjectLocalStorage() : new MessagePortWrappingImplementation._wrap$ctor(raw);
}
...
DocumentFragmentWrappingImplementation.prototype.set$elements = function(value) {
...
PopStateEventWrappingImplementation.prototype.get$state = function() {
  return this._ptr.get$state();
}
...
SharedWorkerWrappingImplementation.prototype.get$port = function() {
  return LevelDom.wrapMessagePort(this._ptr.get$port());
}
...
MVP.prototype.run = function() {
  this.write("Hello World!");
}
MVP.prototype.write = function(message) {
...
EventBus.prototype.bind = function(name, function_) {
  if (this._eventStore == null) {
    this._eventStore = new HashMapImplementation();
  }
  if ($eq(this._eventStore.$index(name))) {
    this._eventStore.$setindex(name, []);
  }
  this._eventStore.$index(name).add$1(function_);
}
EventBus.prototype.trigger = function(name, value) {
  var functions = this._eventStore.$index(name);
  if (functions == null) {
    return;
  }
  functions.forEach$1((function (el) {
    return $eq(value) ? el.call$0() : el.call$1(value);
  })
  );
}
// ********** Code for HistoryManger **************
$inherits(HistoryManger, EventBus);
function HistoryManger() {
  var $this = this; // closure support
  EventBus.call(this);
  html_get$document().get$on().get$click().add(this.get$captureClicks(), false);
  html_get$window().get$on().get$popState().add((function (e) {
    return $this._triggerRoute(e);
  })
  , false);
}
HistoryManger.prototype.captureClicks = function(event) {
  var srcElement = event.get$srcElement();
  if (!!(srcElement && srcElement.is$AnchorElement())) {
    event.preventDefault();
    this.moveTo(srcElement.get$href());
  }
}
HistoryManger.prototype.get$captureClicks = function() {
  return this.captureClicks.bind(this);
}
HistoryManger.prototype.moveTo = function(url) {
  var route = url.replaceAll(html_get$window().get$location().get$protocol(), "").replaceAll(html_get$window().get$location().get$host(), "").replaceAll(html_get$window().get$location().get$port(), "");
  html_get$window().get$history().pushState($add($add("{\"route\":\"", route), "\"}"), "TEST", url);
  this.trigger(route);
}
HistoryManger.prototype._triggerRoute = function(event) {
  var state = event.get$state();
  if (state != null) {
    this.trigger(json_JSON.parse(state).$index("route"));
  }
}
// ********** Code for ActivityMapper **************
function ActivityMapper(_historyManager, _container) {
  this._container = _container;
  this._historyManager = _historyManager;
}
ActivityMapper.prototype.bindRoute = function(route, controller) {
  var $this = this; // closure support
  this._historyManager.bind(route, (function () {
    return controller.start($this._container);
  })
  );
}
// ********** Code for AbstractPresenter **************
function AbstractPresenter() {

}
// ********** Code for TodoPresenter **************
$inherits(TodoPresenter, AbstractPresenter);
function TodoPresenter(_view, _text) {
  this._view = _view;
  this._text = _text;
  AbstractPresenter.call(this);
}
TodoPresenter.prototype.start = function(panel) {
  panel.set$elements([this._view]);
}
// ********** Code for AbstractView **************
function AbstractView() {

}
// ********** Code for TodoView **************
$inherits(TodoView, AbstractView);
function TodoView(todoText) {
  AbstractView.call(this);
  this._li = ElementWrappingImplementation.ElementWrappingImplementation$tag$factory("li");
  this._li.set$innerHTML(("<b>" + todoText + "</b>"));
}
// ********** Code for top level **************
function main() {
  new MVP().run();
  var hm = new HistoryManger();
  var am = new ActivityMapper(hm, html_get$document().query("#mainPanel"));
...
(function(){
  ...
  var v9/*Event*/ = 'Event|AudioProcessingEvent|BeforeLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|ErrorEvent|HashChangeEvent|IDBVersionChangeEvent|MessageEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|XMLHttpRequestProgressEvent|SpeechInputEvent|StorageEvent|TrackEvent|UIEvent|CompositionEvent|KeyboardEvent|MouseEvent|SVGZoomEvent|TextEvent|TouchEvent|WheelEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent';
  var v10/*HTMLCollection*/ = 'HTMLCollection|HTMLOptionsCollection|HTMLPropertiesCollection';
  var v11/*IDBRequest*/ = 'IDBRequest|IDBVersionChangeRequest';
  var v12/*Node*/ = [v2/*CharacterData*/,v3/*Document*/,v4/*Element*/,'Node|Attr|DocumentFragment|DocumentType|Entity|EntityReference|Notation|ProcessingInstruction|ShadowRoot'].join('|');
  var v13/*StyleSheet*/ = 'StyleSheet|CSSStyleSheet';
  var v14/*WorkerContext*/ = 'WorkerContext|DedicatedWorkerContext|SharedWorkerContext';
  var table = [
